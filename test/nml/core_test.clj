...
(let [m (nml-map (slurp "test/nml/nl") :s "test")]
  ...
  (deftest gets
    ...
    (is (= (nml-get m "nB" "i3(1)") "88"                                           ))
    (is (= (nml-get m "nB" "i4(1:2)") "88,88"                                      ))
    (is (= (nml-get m "nB" "i5(2:4:2)") "88,88"                                    ))
    (is (= (nml-get m "nB" "i6(2:)") "88"                                          ))
    (is (= (nml-get m "nb" "i7") ""                                                ))
  ...
  (deftest sets
    (is (= (nml-get (nml-set m "nb" "i3(1)" "66") "nb" "i3(1)") "66"               ))
    (is (= (nml-get (nml-set m "nb" "i4(1:2)" "66,66") "nb" "i4(1:2)") "66,66"     ))
    (is (= (nml-get (nml-set m "nb" "i5(2:4:2)" "66,66") "nb" "i5(2:4:2)") "66,66" ))
